...
const char i_destination[11][20]={"LONDON","BERLIN","DUBAI","DHAKA","BEIJING","PARIS","CANBERRA","TOKYO","WASHINGTON","DELHI","ISLAMABAD" }; //International Destination
		...
		case 49:
			{
				...
				getline(cin,add);
				cout<<"Enter Your Phone Num(Without dashes): ";
				cin>>phone_no;
				date:
